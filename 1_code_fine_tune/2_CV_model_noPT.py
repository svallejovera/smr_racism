...
# Choose tokenizer: 
tokenizer = AutoTokenizer.from_pretrained("xlm-roberta-large", do_lower_case=True)
...
model_name = "xlm-roberta-large" # <- The model you will choose. It has to match the tokenizer
...
with open('xlm_racism_noPT.txt', 'w') as outfile:
  json.dump(racism_stats, outfile)
  
with open('xlm_racism_noPT_folds.txt', 'w') as outfile:
