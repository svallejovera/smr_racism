#####
## Classifier for Overt and Covert Racism: Final Model 
...
model_name = "xlm-roberta-large-finetuned-conll02-spanish" # <- The model you will choose. It has to match the tokenizer
...
model.save_pretrained('/xlm-racismo-noPT/')
