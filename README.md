...
Replication materials for "Machines Do See Color: Using LLMs to Classify Overt and Covert Racism in Text" (2026), by Diana Dávila Gordillo, Joan C Timoneda, and Sebastián Vallejo Vera, at __Sociological Methods & Research__. <img width="191" height="20" alt="image" src="https://github.com/user-attachments/assets/35171ff0-1ac4-4bb0-95f1-91740fb1e79f" />
...
A link to the published version can be found [here](https://github.com/svallejovera/svallejovera.github.io/blob/master/files/racism_smr.pdf). The DOI is [here](https://journals.sagepub.com/doi/10.1177/00491241251412360).
